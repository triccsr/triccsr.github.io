...
![Compiler Path](/uploads/2023-10-06/image-1.png)
...
![Compiler Args](/uploads/2023-10-06/image-3.png)
...
![IntelliSense Mode](/uploads/2023-10-06/image-4.png)

这个选择windows-gcc-x64。

### C/C++ Version

![C/C++ Version](/uploads/2023-10-06/image-5.png)
...
![debug/run/settings](/uploads/2023-10-06/image-6.png)

点击下拉菜单，选择debug或run

![debug/run](/uploads/2023-10-06/image-8.png)

会出现一个菜单

![Compiler Path Menu](/uploads/2023-10-06/image-7.png)
...
![Compile Terminal](/uploads/2023-10-06/image-12.png)

下面这个名字为`cppdbg`的终端是运行程序的，我们在这里输入数据：

![Cppdbg Terminal](/uploads/2023-10-06/image-13.png)
...
![Select Debug Config Menu](/uploads/2023-10-06/image-11.png)
...
![Create launch.json Menu](/uploads/2023-10-06/image-14.png)

在弹出的菜单中选择C++(GDB/LLDB)，然后将生成一个新文件launch.json。初始如图所示：

![launch.json](/uploads/2023-10-06/image-15.png)
